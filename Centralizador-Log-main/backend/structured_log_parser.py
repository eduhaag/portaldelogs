...
class StructuredLogParser:
    ...
    def parse_log_content(self, content: str, enable_multiline: bool = True) -> Dict[str, Any]:
        ...
        for idx, line_content in enumerate(grouped_lines, 1):
            ...
            event = self.parse_line(header_line, idx)
