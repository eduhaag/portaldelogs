...
export class LoginPageComponent implements OnInit {
    ...
    protected login(): void {
        ...
        if (!this.isValidAccessIdentifier(username)) {
            this.loginErrors = ['Informe um usuário válido ou um e-mail válido.'];
            return;
        }
    ...
    private isValidAccessIdentifier(value: string): boolean {
        if (value.includes('@')) {
